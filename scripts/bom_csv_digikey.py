...
# writerow( out, [] )                        # blank line
writerow( out, ["Qty", "Value", "Reference(s)", "LibPart", "DPN", "MPN"] )                   # reuse same columns
...
for group in grouped:
    ...
    row.append( net.getGroupField(group, "DPN") or "");
    row.append( net.getGroupField(group, "MPN") or "");
